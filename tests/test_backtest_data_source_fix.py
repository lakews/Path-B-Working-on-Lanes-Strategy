...
class TestBacktestDataSourceFix:
    ...
    def test_backtest_snapshots_data_source(self):
        ...
        data_quality = results.get("data_quality", {})
        print(f"Snapshots mode - Data points: {data_quality.get('simulated_price_data_points', 0)}, Mode: {data_quality.get('data_source_mode')}")
    ...
    def test_backtest_hybrid_data_source(self):
        ...
        data_quality = results.get("data_quality", {})
        print(f"Hybrid mode - Real: {data_quality.get('real_data_percentage')}%, Mode: {data_quality.get('data_source_mode')}")
