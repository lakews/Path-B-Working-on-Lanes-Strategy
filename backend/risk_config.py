...
class RiskConfig:
    ...
    # 5. ENTRY VALIDATION (Prevents phantom/dust order fills)
    ENTRY_PRICE_FLOOR: float = DEFAULTS['ENTRY_PRICE_FLOOR']
    ENTRY_PRICE_CEILING: float = DEFAULTS['ENTRY_PRICE_CEILING']
    MAX_LIQUIDITY_CONSUMPTION_PCT: float = DEFAULTS['MAX_LIQUIDITY_CONSUMPTION_PCT']
    MIN_LIQUIDITY_COVERAGE_PCT: float = DEFAULTS['MIN_LIQUIDITY_COVERAGE_PCT']
    MAX_SPREAD_ENTRY_PCT: float = DEFAULTS['MAX_SPREAD_ENTRY_PCT']
    ...
    def reset_to_defaults(self):
        ...
        # Entry Validation
        self.ENTRY_PRICE_FLOOR = DEFAULTS['ENTRY_PRICE_FLOOR']
        self.ENTRY_PRICE_CEILING = DEFAULTS['ENTRY_PRICE_CEILING']
        self.MAX_LIQUIDITY_CONSUMPTION_PCT = DEFAULTS['MAX_LIQUIDITY_CONSUMPTION_PCT']
        self.MIN_LIQUIDITY_COVERAGE_PCT = DEFAULTS['MIN_LIQUIDITY_COVERAGE_PCT']
        self.MAX_SPREAD_ENTRY_PCT = DEFAULTS['MAX_SPREAD_ENTRY_PCT']
